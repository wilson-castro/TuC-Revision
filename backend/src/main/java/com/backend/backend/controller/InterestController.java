...
import com.backend.backend.modals.cars.Car;
import com.backend.backend.modals.cars.CarRepo;
import com.backend.backend.modals.interests.Interest;
import com.backend.backend.modals.interests.InterestRepo;
import com.backend.backend.modals.interests.InterestRequestDTO;
import com.backend.backend.modals.interests.InterestResponseDTO;
...
public class InterestController {
    ...
    @PutMapping("{id}")
    public ResponseEntity<?> update(@PathVariable Long id, @RequestBody InterestRequestDTO item) {
        Optional<Interest> existingItemOptional = repository.findById(id);
