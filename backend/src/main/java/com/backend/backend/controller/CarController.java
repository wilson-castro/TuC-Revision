...
import com.backend.backend.modals.cars.CarRequestDTO;
import com.backend.backend.modals.cars.CarResponseDTO;
...
public class CarController {
    ...
    @PutMapping("{id}")
    @RolesAllowed({ "ADMIN" })
    public ResponseEntity<?> update(@PathVariable Long id, @RequestBody CarRequestDTO item) {
        Optional<Car> existingItemOptional = repository.findById(id);
